...
public class CazadorNewbies_ChaseBall : FMSEstadoNewbies
{
    private CazadorNewbies cazador;

    public CazadorNewbies_ChaseBall(
    ...
    public override void UpdateEstado()
    {
        ...
        if( ! GameManager.instancia.isQuaffleControlled())
        {
            ...
            if(Vector3.Distance(cazador.transform.position, cazador.steering.Target.position) < 7f)
            {
                ...
                if(GameManager.instancia.ControlQuaffle(cazador.gameObject))
                {
                    ...
                    fsm.CambiarDeEstado(cazador.estadoBuscarAro);
                }
            }
        }
        else
        {
            ...
            else
            {
                ...
                fsm.CambiarDeEstado(cazador.estadoPerseguirRival);
            }
        }
    }
