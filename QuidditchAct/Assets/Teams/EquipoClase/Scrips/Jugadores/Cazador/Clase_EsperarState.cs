...
public class Clase_EsperarState : Estado_Merodeadores
{
    ...
    public Clase_EsperarState(FSM_Merodeadores fsm, Animator animator, Cazador_Clase cazador) : base(fsm, animator)
    {
