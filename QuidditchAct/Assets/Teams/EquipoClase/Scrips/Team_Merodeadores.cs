...
public class Team_Merodeadores : Team
{
    ...
    /// <summary>
    /// Hay informaci�n que puede no estar disponible en el Start pues no sabemos el orden en que se ejecutan
    /// los equipos, por lo que puede haber informaci�n no disponible.
    /// Este m�todo llena la informaci�n despu�s de cierto tiempo para tratar de asegurar que est� lista.
    /// </summary>
    void FillLateData()
    {
        if (getTeamNumber() == 1)
