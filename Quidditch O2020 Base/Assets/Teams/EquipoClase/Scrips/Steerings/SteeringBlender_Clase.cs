...
public class SteeringBlender_Clase : MonoBehaviour
{
    private Rigidbody rb;

    public float maxForce = 50f;//fuerza maxima que puede alcanzar
    public float maxSpeed = 50f;//velocidad maxima que pueden alcanzar
    public float normalSpeed = 5f;//una verlocidad normal para todos

    private List<SteeringBase_Clase> comportamientos = new List<SteeringBase_Clase>();
    ...
    void Start()
    {
        ...
        SteeringBase_Clase[] arreglo = GetComponents<SteeringBase_Clase>();
    ...
    private Vector3 WeightedTruncatedSum()
    {
        ...
        foreach(SteeringBase_Clase comportamiento in comportamientos)
        {
